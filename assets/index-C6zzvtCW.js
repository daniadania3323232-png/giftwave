 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,G){var J=z.length;z.push(G);e:for(;0<J;){var te=J-1>>>1,Se=z[te];if(0<s(Se,G))z[te]=G,z[J]=Se,J=te;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var G=z[0],J=z.pop();if(J!==G){z[0]=J;e:for(var te=0,Se=z.length,Xn=Se>>>1;te<Xn;){var Ct=2*(te+1)-1,jt=z[Ct],_t=Ct+1,Ut=z[_t];if(0>s(jt,J))_t<Se&&0>s(Ut,jt)?(z[te]=Ut,z[_t]=J,te=_t):(z[te]=jt,z[Ct]=J,te=Ct);else if(_t<Se&&0>s(Ut,J))z[te]=Ut,z[_t]=J,te=_t;else break e}}return G}function s(z,G){var J=z.sortIndex-G.sortIndex;return J!==0?J:z.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;t.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],c=[],f=1,m=null,p=3,E=!1,k=!1,P=!1,D=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(z){for(var G=n(c);G!==null;){if(G.callback===null)r(c);else if(G.startTime<=z)r(c),G.sortIndex=G.expirationTime,e(u,G);else break;G=n(c)}}function b(z){if(P=!1,x(z),!k)if(n(u)!==null)k=!0,Ee(O);else{var G=n(c);G!==null&&rt(b,G.startTime-z)}}function O(z,G){k=!1,P&&(P=!1,I(y),y=-1),E=!0;var J=p;try{for(x(G),m=n(u);m!==null&&(!(m.expirationTime>G)||z&&!C());){var te=m.callback;if(typeof te=="function"){m.callback=null,p=m.priorityLevel;var Se=te(m.expirationTime<=G);G=t.unstable_now(),typeof Se=="function"?m.callback=Se:m===n(u)&&r(u),x(G)}else r(u);m=n(u)}if(m!==null)var Xn=!0;else{var Ct=n(c);Ct!==null&&rt(b,Ct.startTime-G),Xn=!1}return Xn}finally{m=null,p=J,E=!1}}var L=!1,T=null,y=-1,S=5,w=-1;function C(){return!(t.unstable_now()-w<S)}function R(){if(T!==null){var z=t.unstable_now();w=z;var G=!0;try{G=T(!0,z)}finally{G?A():(L=!1,T=null)}}else L=!1}var A;if(typeof v=="function")A=function(){v(R)};else if(typeof MessageChannel<"u"){var ae=new MessageChannel,Ve=ae.port2;ae.port1.onmessage=R,A=function(){Ve.postMessage(null)}}else A=function(){D(R,0)};function Ee(z){T=z,L||(L=!0,A())}function rt(z,G){y=D(function(){z(t.unstable_now())},G)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){k||E||(k=!0,Ee(O))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return p},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(p){case 1:case 2:case 3:var G=3;break;default:G=p}var J=p;p=G;try{return z()}finally{p=J}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,G){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var J=p;p=z;try{return G()}finally{p=J}},t.unstable_scheduleCallback=function(z,G,J){var te=t.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?te+J:te):J=te,z){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=J+Se,z={id:f++,callback:G,priorityLevel:z,startTime:J,expirationTime:Se,sortIndex:-1},J>te?(z.sortIndex=J,e(c,z),n(u)===null&&z===n(c)&&(P?(I(y),y=-1):P=!0,rt(b,J-te))):(z.sortIndex=Se,e(u,z),k||E||(k=!0,Ee(O))),z},t.unstable_shouldYield=C,t.unstable_wrapCallback=function(z){var G=p;return function(){var J=p;p=G;try{return z.apply(this,arguments)}finally{p=J}}}})(fv);dv.exports=fv;var v1=dv.exports;/**
 * @license React
...
*/var br,cE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,y){function S(){}S.prototype=y.prototype,T.F=y.prototype,T.prototype=new S,T.prototype.constructor=T,T.D=function(w,C,R){for(var A=Array(arguments.length-2),ae=2;ae<arguments.length;ae++)A[ae-2]=arguments[ae];return y.prototype[C].apply(w,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,y,S){S||(S=0);const w=Array(16);if(typeof y=="string")for(var C=0;C<16;++C)w[C]=y.charCodeAt(S++)|y.charCodeAt(S++)<<8|y.charCodeAt(S++)<<16|y.charCodeAt(S++)<<24;else for(C=0;C<16;++C)w[C]=y[S++]|y[S++]<<8|y[S++]<<16|y[S++]<<24;y=T.g[0],S=T.g[1],C=T.g[2];let R=T.g[3],A;A=y+(R^S&(C^R))+w[0]+3614090360&4294967295,y=S+(A<<7&4294967295|A>>>25),A=R+(C^y&(S^C))+w[1]+3905402710&4294967295,R=y+(A<<12&4294967295|A>>>20),A=C+(S^R&(y^S))+w[2]+606105819&4294967295,C=R+(A<<17&4294967295|A>>>15),A=S+(y^C&(R^y))+w[3]+3250441966&4294967295,S=C+(A<<22&4294967295|A>>>10),A=y+(R^S&(C^R))+w[4]+4118548399&4294967295,y=S+(A<<7&4294967295|A>>>25),A=R+(C^y&(S^C))+w[5]+1200080426&4294967295,R=y+(A<<12&4294967295|A>>>20),A=C+(S^R&(y^S))+w[6]+2821735955&4294967295,C=R+(A<<17&4294967295|A>>>15),A=S+(y^C&(R^y))+w[7]+4249261313&4294967295,S=C+(A<<22&4294967295|A>>>10),A=y+(R^S&(C^R))+w[8]+1770035416&4294967295,y=S+(A<<7&4294967295|A>>>25),A=R+(C^y&(S^C))+w[9]+2336552879&4294967295,R=y+(A<<12&4294967295|A>>>20),A=C+(S^R&(y^S))+w[10]+4294925233&4294967295,C=R+(A<<17&4294967295|A>>>15),A=S+(y^C&(R^y))+w[11]+2304563134&4294967295,S=C+(A<<22&4294967295|A>>>10),A=y+(R^S&(C^R))+w[12]+1804603682&4294967295,y=S+(A<<7&4294967295|A>>>25),A=R+(C^y&(S^C))+w[13]+4254626195&4294967295,R=y+(A<<12&4294967295|A>>>20),A=C+(S^R&(y^S))+w[14]+2792965006&4294967295,C=R+(A<<17&4294967295|A>>>15),A=S+(y^C&(R^y))+w[15]+1236535329&4294967295,S=C+(A<<22&4294967295|A>>>10),A=y+(C^R&(S^C))+w[1]+4129170786&4294967295,y=S+(A<<5&4294967295|A>>>27),A=R+(S^C&(y^S))+w[6]+3225465664&4294967295,R=y+(A<<9&4294967295|A>>>23),A=C+(y^S&(R^y))+w[11]+643717713&4294967295,C=R+(A<<14&4294967295|A>>>18),A=S+(R^y&(C^R))+w[0]+3921069994&4294967295,S=C+(A<<20&4294967295|A>>>12),A=y+(C^R&(S^C))+w[5]+3593408605&4294967295,y=S+(A<<5&4294967295|A>>>27),A=R+(S^C&(y^S))+w[10]+38016083&4294967295,R=y+(A<<9&4294967295|A>>>23),A=C+(y^S&(R^y))+w[15]+3634488961&4294967295,C=R+(A<<14&4294967295|A>>>18),A=S+(R^y&(C^R))+w[4]+3889429448&4294967295,S=C+(A<<20&4294967295|A>>>12),A=y+(C^R&(S^C))+w[9]+568446438&4294967295,y=S+(A<<5&4294967295|A>>>27),A=R+(S^C&(y^S))+w[14]+3275163606&4294967295,R=y+(A<<9&4294967295|A>>>23),A=C+(y^S&(R^y))+w[3]+4107603335&4294967295,C=R+(A<<14&4294967295|A>>>18),A=S+(R^y&(C^R))+w[8]+1163531501&4294967295,S=C+(A<<20&4294967295|A>>>12),A=y+(C^R&(S^C))+w[13]+2850285829&4294967295,y=S+(A<<5&4294967295|A>>>27),A=R+(S^C&(y^S))+w[2]+4243563512&4294967295,R=y+(A<<9&4294967295|A>>>23),A=C+(y^S&(R^y))+w[7]+1735328473&4294967295,C=R+(A<<14&4294967295|A>>>18),A=S+(R^y&(C^R))+w[12]+2368359562&4294967295,S=C+(A<<20&4294967295|A>>>12),A=y+(S^C^R)+w[5]+4294588738&4294967295,y=S+(A<<4&4294967295|A>>>28),A=R+(y^S^C)+w[8]+2272392833&4294967295,R=y+(A<<11&4294967295|A>>>21),A=C+(R^y^S)+w[11]+1839030562&4294967295,C=R+(A<<16&4294967295|A>>>16),A=S+(C^R^y)+w[14]+4259657740&4294967295,S=C+(A<<23&4294967295|A>>>9),A=y+(S^C^R)+w[1]+2763975236&4294967295,y=S+(A<<4&4294967295|A>>>28),A=R+(y^S^C)+w[4]+1272893353&4294967295,R=y+(A<<11&4294967295|A>>>21),A=C+(R^y^S)+w[7]+4139469664&4294967295,C=R+(A<<16&4294967295|A>>>16),A=S+(C^R^y)+w[10]+3200236656&4294967295,S=C+(A<<23&4294967295|A>>>9),A=y+(S^C^R)+w[13]+681279174&4294967295,y=S+(A<<4&4294967295|A>>>28),A=R+(y^S^C)+w[0]+3936430074&4294967295,R=y+(A<<11&4294967295|A>>>21),A=C+(R^y^S)+w[3]+3572445317&4294967295,C=R+(A<<16&4294967295|A>>>16),A=S+(C^R^y)+w[6]+76029189&4294967295,S=C+(A<<23&4294967295|A>>>9),A=y+(S^C^R)+w[9]+3654602809&4294967295,y=S+(A<<4&4294967295|A>>>28),A=R+(y^S^C)+w[12]+3873151461&4294967295,R=y+(A<<11&4294967295|A>>>21),A=C+(R^y^S)+w[15]+530742520&4294967295,C=R+(A<<16&4294967295|A>>>16),A=S+(C^R^y)+w[2]+3299628645&4294967295,S=C+(A<<23&4294967295|A>>>9),A=y+(C^(S|~R))+w[0]+4096336452&4294967295,y=S+(A<<6&4294967295|A>>>26),A=R+(S^(y|~C))+w[7]+1126891415&4294967295,R=y+(A<<10&4294967295|A>>>22),A=C+(y^(R|~S))+w[14]+2878612391&4294967295,C=R+(A<<15&4294967295|A>>>17),A=S+(R^(C|~y))+w[5]+4237533241&4294967295,S=C+(A<<21&4294967295|A>>>11),A=y+(C^(S|~R))+w[12]+1700485571&4294967295,y=S+(A<<6&4294967295|A>>>26),A=R+(S^(y|~C))+w[3]+2399980690&4294967295,R=y+(A<<10&4294967295|A>>>22),A=C+(y^(R|~S))+w[10]+4293915773&4294967295,C=R+(A<<15&4294967295|A>>>17),A=S+(R^(C|~y))+w[1]+2240044497&4294967295,S=C+(A<<21&4294967295|A>>>11),A=y+(C^(S|~R))+w[8]+1873313359&4294967295,y=S+(A<<6&4294967295|A>>>26),A=R+(S^(y|~C))+w[15]+4264355552&4294967295,R=y+(A<<10&4294967295|A>>>22),A=C+(y^(R|~S))+w[6]+2734768916&4294967295,C=R+(A<<15&4294967295|A>>>17),A=S+(R^(C|~y))+w[13]+1309151649&4294967295,S=C+(A<<21&4294967295|A>>>11),A=y+(C^(S|~R))+w[4]+4149444226&4294967295,y=S+(A<<6&4294967295|A>>>26),A=R+(S^(y|~C))+w[11]+3174756917&4294967295,R=y+(A<<10&4294967295|A>>>22),A=C+(y^(R|~S))+w[2]+718787259&4294967295,C=R+(A<<15&4294967295|A>>>17),A=S+(R^(C|~y))+w[9]+3951481745&4294967295,T.g[0]=T.g[0]+y&4294967295,T.g[1]=T.g[1]+(C+(A<<21&4294967295|A>>>11))&4294967295,T.g[2]=T.g[2]+C&4294967295,T.g[3]=T.g[3]+R&4294967295}r.prototype.v=function(T,y){y===void 0&&(y=T.length);const S=y-this.blockSize,w=this.C;let C=this.h,R=0;for(;R<y;){if(C==0)for(;R<=S;)s(this,T,R),R+=this.blockSize;if(typeof T=="string"){for(;R<y;)if(w[C++]=T.charCodeAt(R++),C==this.blockSize){s(this,w),C=0;break}}else for(;R<y;)if(w[C++]=T[R++],C==this.blockSize){s(this,w),C=0;break}}this.h=C,this.o+=y},r.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var y=1;y<T.length-8;++y)T[y]=0;y=this.o*8;for(var S=T.length-8;S<T.length;++S)T[S]=y&255,y/=256;for(this.v(T),T=Array(16),y=0,S=0;S<4;++S)for(let w=0;w<32;w+=8)T[y++]=this.g[S]>>>w&255;return T};function i(T,y){var S=l;return Object.prototype.hasOwnProperty.call(S,T)?S[T]:S[T]=y(T)}function o(T,y){this.h=y;const S=[];let w=!0;for(let C=T.length-1;C>=0;C--){const R=T[C]|0;w&&R==y||(S[C]=R,w=!1)}this.g=S}var l={};function u(T){return-128<=T&&T<128?i(T,function(y){return new o([y|0],y<0?-1:0)}):new o([T|0],T<0?-1:0)}function c(T){if(isNaN(T)||!isFinite(T))return m;if(T<0)return D(c(-T));const y=[];let S=1;for(let w=0;T>=S;w++)y[w]=T/S|0,S*=4294967296;return new o(y,0)}function f(T,y){if(T.length==0)throw Error("number format error: empty string");if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(T.charAt(0)=="-")return D(f(T.substring(1),y));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const S=c(Math.pow(y,8));let w=m;for(let R=0;R<T.length;R+=8){var C=Math.min(8,T.length-R);const A=parseInt(T.substring(R,R+C),y);C<8?(C=c(Math.pow(y,C)),w=w.j(C).add(c(A))):(w=w.j(S),w=w.add(c(A)))}return w}var m=u(0),p=u(1),E=u(16777216);t=o.prototype,t.m=function(){if(P(this))return-D(this).m();let T=0,y=1;for(let S=0;S<this.g.length;S++){const w=this.i(S);T+=(w>=0?w:4294967296+w)*y,y*=4294967296}return T},t.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(k(this))return"0";if(P(this))return"-"+D(this).toString(T);const y=c(Math.pow(T,6));var S=this;let w="";for(;;){const C=b(S,y).g;S=I(S,C.j(y));let R=((S.g.length>0?S.g[0]:S.h)>>>0).toString(T);if(S=C,k(S))return R+w;for(;R.length<6;)R="0"+R;w=R+w}},t.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function k(T){if(T.h!=0)return!1;for(let y=0;y<T.g.length;y++)if(T.g[y]!=0)return!1;return!0}function P(T){return T.h==-1}t.l=function(T){return T=I(this,T),P(T)?-1:k(T)?0:1};function D(T){const y=T.g.length,S=[];for(let w=0;w<y;w++)S[w]=~T.g[w];return new o(S,~T.h).add(p)}t.abs=function(){return P(this)?D(this):this},t.add=function(T){const y=Math.max(this.g.length,T.g.length),S=[];let w=0;for(let C=0;C<=y;C++){let R=w+(this.i(C)&65535)+(T.i(C)&65535),A=(R>>>16)+(this.i(C)>>>16)+(T.i(C)>>>16);w=A>>>16,R&=65535,A&=65535,S[C]=A<<16|R}return new o(S,S[S.length-1]&-2147483648?-1:0)};function I(T,y){return T.add(D(y))}t.j=function(T){if(k(this)||k(T))return m;if(P(this))return P(T)?D(this).j(D(T)):D(D(this).j(T));if(P(T))return D(this.j(D(T)));if(this.l(E)<0&&T.l(E)<0)return c(this.m()*T.m());const y=this.g.length+T.g.length,S=[];for(var w=0;w<2*y;w++)S[w]=0;for(w=0;w<this.g.length;w++)for(let C=0;C<T.g.length;C++){const R=this.i(w)>>>16,A=this.i(w)&65535,ae=T.i(C)>>>16,Ve=T.i(C)&65535;S[2*w+2*C]+=A*Ve,v(S,2*w+2*C),S[2*w+2*C+1]+=R*Ve,v(S,2*w+2*C+1),S[2*w+2*C+1]+=A*ae,v(S,2*w+2*C+1),S[2*w+2*C+2]+=R*ae,v(S,2*w+2*C+2)}for(T=0;T<y;T++)S[T]=S[2*T+1]<<16|S[2*T];for(T=y;T<2*y;T++)S[T]=0;return new o(S,0)};function v(T,y){for(;(T[y]&65535)!=T[y];)T[y+1]+=T[y]>>>16,T[y]&=65535,y++}function x(T,y){this.g=T,this.h=y}function b(T,y){if(k(y))throw Error("division by zero");if(k(T))return new x(m,m);if(P(T))return y=b(D(T),y),new x(D(y.g),D(y.h));if(P(y))return y=b(T,D(y)),new x(D(y.g),y.h);if(T.g.length>30){if(P(T)||P(y))throw Error("slowDivide_ only works with positive integers.");for(var S=p,w=y;w.l(T)<=0;)S=O(S),w=O(w);var C=L(S,1),R=L(w,1);for(w=L(w,2),S=L(S,2);!k(w);){var A=R.add(w);A.l(T)<=0&&(C=C.add(S),R=A),w=L(w,1),S=L(S,1)}return y=I(T,C.j(y)),new x(C,y)}for(C=m;T.l(y)>=0;){for(S=Math.max(1,Math.floor(T.m()/y.m())),w=Math.ceil(Math.log(S)/Math.LN2),w=w<=48?1:Math.pow(2,w-48),R=c(S),A=R.j(y);P(A)||A.l(T)>0;)S-=w,R=c(S),A=R.j(y);k(R)&&(R=p),C=C.add(R),T=I(T,A)}return new x(C,T)}t.B=function(T){return b(this,T).h},t.and=function(T){const y=Math.max(this.g.length,T.g.length),S=[];for(let w=0;w<y;w++)S[w]=this.i(w)&T.i(w);return new o(S,this.h&T.h)},t.or=function(T){const y=Math.max(this.g.length,T.g.length),S=[];for(let w=0;w<y;w++)S[w]=this.i(w)|T.i(w);return new o(S,this.h|T.h)},t.xor=function(T){const y=Math.max(this.g.length,T.g.length),S=[];for(let w=0;w<y;w++)S[w]=this.i(w)^T.i(w);return new o(S,this.h^T.h)};function O(T){const y=T.g.length+1,S=[];for(let w=0;w<y;w++)S[w]=T.i(w)<<1|T.i(w-1)>>>31;return new o(S,T.h)}function L(T,y){const S=y>>5;y%=32;const w=T.g.length-S,C=[];for(let R=0;R<w;R++)C[R]=y>0?T.i(R+S)>>>y|T.i(R+S+1)<<32-y:T.i(R+S);return new o(C,T.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,cE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=f,br=o}).apply(typeof Ly<"u"?Ly:typeof self<"u"?self:typeof window<"u"?window:{});var fl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oi(t){if(t.code!==M.FAILED_PRECONDITION||t.message!==FR)throw t;q("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yb{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return jx()?8:UR(ht())>0?6:4}()}initialize(e,n){this.fs=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.gs(e,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.ps(e,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new gb;return this.ys(e,n,o).next(l=>{if(i.result=l,this.As)return this.ws(e,n,o,l.size)})}).next(()=>i.result)}ws(e,n,r,s){return r.documentReadCount<this.Vs?(Bs()<=se.DEBUG&&q("QueryEngine","SDK will not create cache indexes for query:",$s(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),F.resolve()):(Bs()<=se.DEBUG&&q("QueryEngine","Query:",$s(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(Bs()<=se.DEBUG&&q("QueryEngine","The SDK decides to create cache indexes for query:",$s(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,In(n))):F.resolve())}gs(e,n){if(e_(n))return F.resolve(null);let r=In(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=$d(n,null,"F"),r=In(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=oe(...i);return this.fs.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const c=this.bs(n,l);return this.Ss(n,c,o,u.readTime)?this.gs(e,$d(n,null,"F")):this.Ds(e,c,n,u)}))})))}ps(e,n,r,s){return e_(n)||s.isEqual(X.min())?F.resolve(null):this.fs.getDocuments(e,r).next(i=>{const o=this.bs(n,i);return this.Ss(n,o,r,s)?F.resolve(null):(Bs()<=se.DEBUG&&q("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),$s(n)),this.Ds(e,o,n,OR(s,da)).next(l=>l))})}bs(e,n){let r=new Be(FE(e));return n.forEach((s,i)=>{uc(e,i)&&(r=r.add(i))}),r}Ss(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ys(e,n,r){return Bs()<=se.DEBUG&&q("QueryEngine","Using full collection scan to execute query:",$s(n)),this.fs.getDocumentsMatchingQuery(e,n,Lr.min(),r)}Ds(e,n,r,s){return this.fs.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const m_="ConnectivityMonitor";class g_{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(e){this.Lo.push(e)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){q(m_,"Network connectivity changed: AVAILABLE");for(const e of this.Lo)e(0)}Bo(){q(m_,"Network connectivity changed: UNAVAILABLE");for(const e of this.Lo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ot="WebChannelConnection",po=(t,e,n)=>{t.listen(e,r=>{try{n(r)}catch(s){setTimeout(()=>{throw s},0)}})};class pi extends Pb{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!pi.c_){const e=pE();po(e,fE.STAT_EVENT,n=>{n.stat===Ld.PROXY?q(ot,"STAT_EVENT: detected buffering proxy"):n.stat===Ld.NOPROXY&&q(ot,"STAT_EVENT: detected no buffering proxy")}),pi.c_=!0}}zo(e,n,r,s,i){const o=Qd();return new Promise((l,u)=>{const c=new hE;c.setWithCredentials(!0),c.listenOnce(dE.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case Ll.NO_ERROR:const m=c.getResponseJson();q(ot,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(m)),l(m);break;case Ll.TIMEOUT:q(ot,`RPC '${e}' ${o} timed out`),u(new B(M.DEADLINE_EXCEEDED,"Request time out"));break;case Ll.HTTP_ERROR:const p=c.getStatus();if(q(ot,`RPC '${e}' ${o} failed with status:`,p,"response text:",c.getResponseText()),p>0){let E=c.getResponseJson();Array.isArray(E)&&(E=E[0]);const k=E==null?void 0:E.error;if(k&&k.status&&k.message){const P=function(I){const v=I.toLowerCase().replace(/_/g,"-");return Object.values(M).indexOf(v)>=0?v:M.UNKNOWN}(k.status);u(new B(P,k.message))}else u(new B(M.UNKNOWN,"Server responded with status "+c.getStatus()))}else u(new B(M.UNAVAILABLE,"Connection failed."));break;default:Y(9055,{l_:e,streamId:o,h_:c.getLastErrorCode(),P_:c.getLastError()})}}finally{q(ot,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(s);q(ot,`RPC '${e}' ${o} sending request:`,s),c.send(n,"POST",f,r,15)})}T_(e,n,r){const s=Qd(),i=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Go(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const c=i.join("");q(ot,`Creating RPC '${e}' stream ${s}: ${c}`,l);const f=o.createWebChannel(c,l);this.I_(f);let m=!1,p=!1;const E=new bb({Ho:k=>{p?q(ot,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(m||(q(ot,`Opening RPC '${e}' stream ${s} transport.`),f.open(),m=!0),q(ot,`RPC '${e}' stream ${s} sending:`,k),f.send(k))},Jo:()=>f.close()});return po(f,xo.EventType.OPEN,()=>{p||(q(ot,`RPC '${e}' stream ${s} transport opened.`),E.i_())}),po(f,xo.EventType.CLOSE,()=>{p||(p=!0,q(ot,`RPC '${e}' stream ${s} transport closed`),E.o_(),this.E_(f))}),po(f,xo.EventType.ERROR,k=>{p||(p=!0,Ts(ot,`RPC '${e}' stream ${s} transport errored. Name:`,k.name,"Message:",k.message),E.o_(new B(M.UNAVAILABLE,"The operation could not be completed")))}),po(f,xo.EventType.MESSAGE,k=>{var P;if(!p){const D=k.data[0];ce(!!D,16349);const I=D,v=(I==null?void 0:I.error)||((P=I[0])==null?void 0:P.error);if(v){q(ot,`RPC '${e}' stream ${s} received error:`,v);const x=v.status;let b=function(T){const y=Oe[T];if(y!==void 0)return YE(y)}(x),O=v.message;x==="NOT_FOUND"&&O.includes("database")&&O.includes("does not exist")&&O.includes(this.databaseId.database)&&Ts(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),b===void 0&&(b=M.INTERNAL,O="Unknown error status: "+x+" with message "+v.message),p=!0,E.o_(new B(b,O)),f.close()}else q(ot,`RPC '${e}' stream ${s} received:`,D),E.__(D)}}),pi.u_(),setTimeout(()=>{E.s_()},0),E}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter(n=>n===e)}Go(e,n,r){super.Go(e,n,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return mE()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=nn.makeFromUrl(e,n)}catch{return new nn(e,"")}if(r.path==="")return r;throw wD(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(b){b.path.charAt(b.path.length-1)==="/"&&(b.path_=b.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),u={bucket:1,path:3};function c(b){b.path_=decodeURIComponent(b.path)}const f="v[A-Za-z0-9_]+",m=n.replace(/[.]/g,"\\."),p="(/([^?#]*).*)?$",E=new RegExp(`^https?://${m}/${f}/b/${s}/o${p}`,"i"),k={bucket:1,path:3},P=n===cI?"(?:storage.googleapis.com|storage.cloud.google.com)":n,D="([^?#]*)",I=new RegExp(`^https?://${P}/${s}/${D}`,"i"),x=[{regex:l,indices:u,postModify:i},{regex:E,indices:k,postModify:c},{regex:I,indices:{bucket:1,path:2},postModify:c}];for(let b=0;b<x.length;b++){const O=x[b],L=O.regex.exec(e);if(L){const T=L[O.indices.bucket];let y=L[O.indices.path];y||(y=""),r=new nn(T,y),O.postModify(r);break}}if(r==null)throw vD(e);return r}}class TD{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ID(t,e,n){let r=1,s=null,i=null,o=!1,l=0;function u(){return l===2}let c=!1;function f(...D){c||(c=!0,e.apply(null,D))}function m(D){s=setTimeout(()=>{s=null,t(E,u())},D)}function p(){i&&clearTimeout(i)}function E(D,...I){if(c){p();return}if(D){p(),f.call(null,D,...I);return}if(u()||o){p(),f.call(null,D,...I);return}r<64&&(r*=2);let x;l===1?(l=2,x=0):x=(r+Math.random())*1e3,m(x)}let k=!1;function P(D){k||(k=!0,p(),!c&&(s!==null?(D||(l=2),clearTimeout(s),m(0)):D||(l=1)))}return m(0),i=setTimeout(()=>{o=!0,P(!0)},n),P}function SD(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dI="storage";function FD(t=Zu(),e){t=Ie(t);const r=Hr(t,dI).getImmediate({identifier:e}),s=yw("storage");return s&&jD(r,...s),r}function jD(t,e,n,r={}){LD(t,e,n,r)}function UD(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new MD(n,r,s,e,bs)}function zD(){un(new Qt(dI,UD,"PUBLIC").setMultipleInstances(!0)),At(K_,Q_,""),At(K_,Q_,"esm2020")}zD();const BD={apiKey:"AIzaSyCXKm1hPvq38S_13C95meJAvmMXcZ8M1fQ",authDomain:"giftwave-pro.firebaseapp.com",projectId:"giftwave-pro",storageBucket:"giftwave-pro.firebasestorage.app",messagingSenderId:"964612051931",appId:"1:964612051931:web:c318a4f6ba21c51d3a8dfe",measurementId:"G-Z8YJ83DXW2"},Sc=Cw(BD),mn=ER(Sc),Je=R2(Sc);FD(Sc);typeof window<"u"&&lD(Sc);const fI=H.createContext();function $D({children:t}){const[e,n]=H.useState(null),[r,s]=H.useState([]),[i,o]=H.useState(!0);H.useEffect(()=>{const E=setTimeout(()=>{o(!1)},3e3),k=uk(mn,async D=>{try{if(D){const I=bn(Je,"users",D.uid),v=await B2(I);if(v.exists()){const x=D.emailVerified,b={id:D.uid,...v.data(),isVerified:x};n(b),await ss(I,{lastSeen:"online"})}}else e&&await ss(bn(Je,"users",e.id),{lastSeen:new Date().toISOString()}),n(null)}catch(I){console.error("Auth error:",I)}finally{clearTimeout(E),o(!1)}},D=>{console.error("Auth state error:",D),clearTimeout(E),o(!1)}),P=()=>{mn.currentUser&&ss(bn(Je,"users",mn.currentUser.uid),{lastSeen:new Date().toISOString()})};return window.addEventListener("beforeunload",P),()=>{k(),clearTimeout(E),window.removeEventListener("beforeunload",P)}},[]),H.useEffect(()=>{if(e&&e.isVerified){const E=qo(Dn(Je,"users"));return ef(E,P=>{const D=P.docs.map(I=>({id:I.id,...I.data()}));s(D)})}},[e]);const l=async(E,k,P,D,I)=>{try{const v=Dn(Je,"users"),x=qo(v,Zd("username","==",E));if(!(await L_(x)).empty)return{error:"Этот юзернейм уже занят. Выберите другой."};const L=(await sk(mn,D,k)).user;await ok(L);const T={username:E.toLowerCase(),displayName:I||E,bio:P,email:D,phone:"",isVerified:!1,role:E.toLowerCase()==="admin"?"admin":"user",avatar:`https://api.dicebear.com/7.x/shapes/svg?seed=${E}`,coins:500,createdAt:new Date().toISOString()};return await $2(bn(Je,"users",L.uid),T),n({id:L.uid,...T}),{success:!0}}catch(v){let x=v.message;return v.code==="auth/email-already-in-use"&&(x="Пользователь с такой почтой уже зарегистрирован."),{error:x}}},u=async(E,k)=>{try{return await ik(mn,E,k),{success:!0}}catch{return{error:"Неверный логин или пароль"}}},c=async()=>{if(!mn.currentUser)return;await mn.currentUser.reload();const E=mn.currentUser.emailVerified;return E&&(await ss(bn(Je,"users",mn.currentUser.uid),{isVerified:!0}),n(k=>({...k,isVerified:!0}))),E},f=async(E,k)=>{if((e==null?void 0:e.role)!=="admin")return{error:"Access denied"};try{const D=(r.find(I=>I.id===E).coins||0)+parseInt(k);return await ss(bn(Je,"users",E),{coins:D}),s(I=>I.map(v=>v.id===E?{...v,coins:D}:v)),{success:!0}}catch(P){return{error:P.message}}},m=()=>ck(mn),p=async E=>{if(e)try{if(E.username&&E.username!==e.username){const P=Dn(Je,"users"),D=qo(P,Zd("username","==",E.username));if(!(await L_(D)).empty)return{error:"Этот юзернейм уже занят."}}const k=bn(Je,"users",e.id);return await ss(k,E),n(P=>({...P,...E})),{success:!0}}catch(k){return console.error("Error updating user:",k),{error:k.message}}};return g.jsx(fI.Provider,{value:{user:e,allUsers:r,register:l,login:u,logout:m,checkVerification:c,giveCoins:f,updateUser:p,loading:i},children:!i&&t})}const Os=()=>H.useContext(fI);function qD(t,e){const[n,r]=H.useState(()=>{try{const s=localStorage.getItem(t);if(s!==null)return JSON.parse(s)}catch(s){console.error(`Error reading localStorage key "${t}":`,s)}return e});return H.useEffect(()=>{try{localStorage.setItem(t,JSON.stringify(n))}catch(s){console.error(`Error setting localStorage key "${t}":`,s)}},[t,n]),[n,r]}const pI=H.createContext();function WD({children:t}){const{user:e}=Os(),[n,r]=H.useState([]),[s,i]=qD("activeChatId",null),[o,l]=H.useState(s),[u,c]=H.useState([]),[f,m]=H.useState([]),p=v=>{l(v),i(v)};H.useEffect(()=>{if(!e){r([]);return}const v=qo(Dn(Je,"chats"),Zd("participants","array-contains",e.id));return ef(v,b=>{const O=b.docs.map(L=>({id:L.id,...L.data()}));r(O)})},[e]),H.useEffect(()=>{if(!o){c([]);return}const v=qo(Dn(Je,`chats/${o}/messages`),U2("timestamp","asc"));return ef(v,b=>{const O=b.docs.map(L=>({id:L.id,...L.data()}));c(O)})},[o]);const E=async v=>{if(!e)return;const x=n.find(L=>L.type==="dm"&&L.participants.includes(v.id));if(x){p(x.id);return}const b={type:"dm",name:v.username,participants:[e.id,v.id],lastMessage:null,createdAt:mo()},O=await _l(Dn(Je,"chats"),b);p(O.id)},k=async(v,x)=>{const b={type:"group",name:v,participants:[...x,e.id],lastMessage:"Группа создана",createdAt:mo()},O=await _l(Dn(Je,"chats"),b);p(O.id)},P=async(v,x)=>{const b={type:"channel",name:v,participants:[...x,e.id],lastMessage:"Канал создан",createdAt:mo()},O=await _l(Dn(Je,"chats"),b);p(O.id)},D=async(v,x="text",b={})=>{if(!e||!o)return;const O={chatId:o,text:v,senderId:e.id,senderName:e.username,type:x,metadata:b,timestamp:mo()};await _l(Dn(Je,`chats/${o}/messages`),O),await ss(bn(Je,"chats",o),{lastMessage:v,lastUpdated:mo()})},I=(v,x=8e3)=>{const b=Date.now();m(O=>[...O,{id:b,type:v}]),setTimeout(()=>m(O=>O.filter(L=>L.id!==b)),x)};return g.jsx(pI.Provider,{value:{chats:n,activeChatId:o,setActiveChatId:p,messages:u,sendMessage:D,startPrivateChat:E,createGroup:k,createChannel:P,activeEffects:f,applyEffect:I},children:t})}const ji=()=>H.useContext(pI);/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const GD=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),fe=(t,e)=>{const n=H.forwardRef(({color:r="currentColor",size:s=24,strokeWidth:i=2,absoluteStrokeWidth:o,className:l="",children:u,...c},f)=>H.createElement("svg",{ref:f,...HD,width:s,height:s,stroke:r,strokeWidth:o?Number(i)*24/Number(s):i,className:["lucide",`lucide-${GD(t)}`,l].join(" "),...c},[...e.map(([m,p])=>H.createElement(m,p)),...Array.isArray(u)?u:[u]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
